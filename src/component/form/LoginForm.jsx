  ...
  const handleSubmit = (event) =>{
    ...
    if (credentials.username && credentials.password){
        postLogin(
            ...
            window.localStorage.setItem("token", response.token); //a sign of proof that our users are logged in. We need to add this line in every login page requirement.
